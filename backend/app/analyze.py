...
CATALOG: tuple[CatalogFood, ...] = (
    CatalogFood("glazed donut", 22.0, 0.86, ("donut", "doughnut")),
    CatalogFood("chocolate chip cookie", 12.0, 0.81, ("cookie",)),
    CatalogFood("cola", 39.0, 0.93, ("cola", "soda")),
    CatalogFood("banana", 14.0, 0.90, ("banana",)),
    CatalogFood("apple", 10.0, 0.88, ("apple",)),
    CatalogFood("oatmeal", 1.0, 0.84, ("oatmeal", "oats")),
    CatalogFood("grilled chicken", 0.0, 0.92, ("chicken",)),
    CatalogFood("cucumber", 1.7, 0.89, ("cucumber",)),
    CatalogFood("boiled eggs", 0.6, 0.87, ("egg", "eggs")),
    CatalogFood("celery sticks", 1.2, 0.83, ("celery",)),
)

DEFAULT_FOOD = CatalogFood("mixed snack", 18.0, 0.50)
...
def low_sugar_alternatives(exclude_label: str) -> list[tuple[str, float]]:
    ...
    for label in ALTERNATIVE_LABELS:
        ...
        picked.append((food.label, food.sugar_g))
    return picked
